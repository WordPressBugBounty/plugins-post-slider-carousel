...
;(function($){
	...
	$.fn.bxSlider_vertical = function(options){
		...
		var setup = function(){
			...
			el.wrap('<div class="bx-wrapper"><div class="bx-viewport_psc"></div></div>');
			// store a namspace reference to .bx-viewport_psc
			...
			// make modifications to the viewport (.bx-viewport_psc)
			slider.viewport.css({
				width: '100%',
				overflow: 'hidden',
				position: 'relative'
	  ...
	  if($(e.target).parent()[0].hasAttribute('data-href')){
		...
		el.goToSlide = function(slideIndex, direction){
			...
			if(slideIndex < 0){
				...
				$(el[0]).attr('data-current',slider.active.index);
